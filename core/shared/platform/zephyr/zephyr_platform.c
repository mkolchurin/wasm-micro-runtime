...
ssize_t
pread(int fd, const struct iovec *iov, int iovcnt, off_t offset)
{
    errno = ENOSYS;
    return -1;
}
...
ssize_t
pwrite(int fd, const struct iovec *iov, int iovcnt, off_t offset)
{
    errno = ENOSYS;
    return -1;
}
...
//__wasi_errno_t
// os_preadv(os_file_handle handle, const struct __wasi_iovec_t *iov, int
// iovcnt,
...
//__wasi_errno_t
// os_pwritev(os_file_handle handle, const struct __wasi_ciovec_t *iov, int
// iovcnt,
...
//__wasi_errno_t
// os_writev(os_file_handle handle, const struct __wasi_ciovec_t *iov, int
// iovcnt,
//          size_t *nwritten)
//{
//    return 0;
...
//__wasi_errno_t
// os_symlinkat(const char *old_path, os_file_handle handle, const char
// *new_path)
//{
//    return __WASI_ENOTSUP;
//}
...
// int
// os_socket_recv_from(bh_socket_t socket, void *buf, unsigned int len, int
// flags,
...
// int
// os_socket_inet_network(bool is_ipv4, const char *cp, bh_ip_addr_buffer_t
// *out)
//{
//     return -1;
// }
...
// int
// os_socket_set_ip_multicast_loop(bh_socket_t socket, bool ipv6, bool
// is_enabled)
//{
//     return -1;
// }
...
// int
// os_socket_get_ip_multicast_loop(bh_socket_t socket, bool ipv6, bool
// *is_enabled)
//{
//     return -1;
// }
